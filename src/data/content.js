...
export const posts = [
    {
        ...
        body: [
            ...
            'When I think about expectations, I always go back to class three in 2011. My beloved teacher, Mr Agin, could cane me for not scoring 100% in mathematics. He would tell me directly that he wanted me to become a professor. I also remember Madam Ruth, whom we sadly lost the other day, and it is still so painful. She could even speak privately with my mother about good success and better opportunities for my future. At the time it all felt harsh and impossible. But hidden in that pressure was a strange kind of belief: people seeing a future in me that I could not yet see for myself.',
