  ...
  return (
    <aside className="w-full md:w-[280px] md:shrink-0 md:sticky md:top-16 md:self-start">
      ...
      <a
        ...
        className="inline-flex items-center gap-2.5 mt-2 mb-5 px-3 py-2 rounded-md border border-[#FFB900]/40 bg-[#FFF8E7] hover:bg-[#FFF2CC] transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#FFB900]/60"
      >
